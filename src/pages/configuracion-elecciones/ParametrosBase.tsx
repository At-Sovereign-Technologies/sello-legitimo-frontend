...
export default function ParametrosBase() {
    ...
    const [fechaInicio, setFechaInicio] = useState(
        draftPaso1.fechaInicio ?? "",
    );
    const [fechaCierre, setFechaCierre] = useState(
        draftPaso1.fechaCierre ?? "",
    );
    const [jornadaExtendida, setJornadaExtendida] = useState(
        draftPaso1.jornadaExtendida ?? true,
    );
    const [horaApertura, setHoraApertura] = useState(
        draftPaso1.horaApertura ?? "08:00",
    );
    const [horaCierre, setHoraCierre] = useState(
        draftPaso1.horaCierre ?? "16:00",
    );
    const [votacionPresencial, setVotacionPresencial] = useState(
        draftPaso1.votacionPresencial ?? true,
    );
    const [votacionRemota, setVotacionRemota] = useState(
        draftPaso1.votacionRemota ?? true,
    );
    ...
    function handleTipoEleccionChange(nextTipoEleccion: string) {
        ...
        const paso2Normalizado = sanitizePaso2Draft(
            nextTipoEleccion,
            draftPaso2,
        );
        ...
        <div className="min-h-screen bg-gray-50 flex flex-col">
            ...
            <main className="flex-1 px-8 py-6 max-w-4xl mx-auto w-full">
                ...
                <p className="text-sm text-gray-500 mb-6">
                    Cumplimiento RF-MI-001 y RF-MI-007 - Sistema de alta
                    transparencia para Colombia
                </p>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setNombreEleccion(e.target.value)
                                }
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <select
                                    value={tipoEleccion}
                                    onChange={(e) =>
                                        handleTipoEleccionChange(e.target.value)
                                    }
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xs text-gray-500 mt-0.5">
                                    Habilitar restricciones de horario y
                                    continuos durante los días específicos en
                                </p>
                            </div>
                            {/* Toggle */}
                            <button
                                type="button"
                                onClick={() =>
                                    setJornadaExtendida(!jornadaExtendida)
                                }
                ...
                <div className="bg-white border rounded-xl p-6 mb-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div
                            ...
                            onClick={() =>
                                setVotacionPresencial(!votacionPresencial)
                            }
                        >
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs text-gray-500">
                                        Urnas tradicionales y puestos de
                                        votación físicos en todo el territorio
                                        nacional.
                                    </p>
                                </div>
                            </div>
                        ...
                        >
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs text-gray-500">
                                        Plataforma digital segura para
                                        circunscripciones específicas o diáspora
                                        a través de portal seguro.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                {(errorGuardado || guardadoExitoso) && (
                    ...
                    >
                        {errorGuardado ||
                            "Avance guardado localmente. Se enviará al final."}
                    </div>
                )}
            ...
            <footer className="border-t bg-white py-3 px-8 text-center text-xs text-gray-400">
                Configuración del Sistema RF-MI-001 / RF-MI-007 | Guardar Sello
                Legítimo
            </footer>
        </div>
    );
