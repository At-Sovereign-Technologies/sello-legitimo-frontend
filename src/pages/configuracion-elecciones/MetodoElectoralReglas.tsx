...
const modelos: {
    ...
    },
    {
        ...
        descripcion:
            "Se vota por partido y candidato, y el orden lo define el votante.",
    },
    {
        id: "cerrada",
        titulo: "Lista de Partido Cerrada",
        descripcion:
            "Se vota solo por el partido y el orden ya viene definido.",
    },
];
...
export default function MetodoElectoralReglas() {
    ...
    const paso2Inicial = sanitizePaso2Draft(
        draftPaso1.tipoEleccion,
        draftPaso2,
    );
    const presetTipoEleccion = getTipoEleccionPreset(draftPaso1.tipoEleccion);

    const [metodoSeleccionado, setMetodoSeleccionado] =
        useState<MetodoElectoral>(paso2Inicial.metodoSeleccionado);
    const [umbralElectoral, setUmbralElectoral] = useState(
        paso2Inicial.umbralElectoral,
    );
    const [metodoCurules, setMetodoCurules] = useState(
        paso2Inicial.metodoCurules,
    );
    const [modelosCandidatura, setModelosCandidatura] = useState<
        ModeloCandidatura[]
    ...
    const [idiomaTargeton, setIdiomaTargeton] = useState(
        paso2Inicial.idiomaTargeton,
    );
    const [numeroCurules, setNumeroCurules] = useState(
        paso2Inicial.numeroCurules,
    );
    ...
    const modelosCompatibles =
        presetTipoEleccion?.modelosCompatibles ??
        getModelosCompatibles(metodoSeleccionado);
    ...
    const [tabLegislativa, setTabLegislativa] = useState<"senado" | "camara">(
        "senado",
    );
    ...
    const [configCamara, setConfigCamara] = useState<
        ConfiguracionCamaraDepto[]
    >(paso2Inicial.configuracionCamara ?? defaultConfiguracionCamara());
    const [configCamaraEspeciales, setConfigCamaraEspeciales] = useState<
        ConfiguracionCamaraEspecial[]
    >(
        paso2Inicial.configuracionCamaraEspeciales ??
            defaultConfiguracionCamaraEspeciales(),
    );
    ...
    function handleMetodoSeleccion(nextMetodo: MetodoElectoral) {
        ...
        applyPaso2State(
            normalizeCurrentPaso2({ metodoSeleccionado: nextMetodo }),
        );
    }
    ...
    function handleModeloToggle(modelo: ModeloCandidatura) {
        ...
        applyPaso2State(
            normalizeCurrentPaso2({ modelosCandidatura: nuevosModelos }),
        );
    }
        ...
        try {
            ...
            setErrorGuardado(
                error instanceof Error
                    ? error.message
                    : "No se pudo guardar el avance local",
            );
            throw error;
        } finally {
            setGuardando(false);
        ...
        <div className="min-h-screen bg-gray-50 flex flex-col">
            ...
            <main className="flex-1 px-8 py-6 max-w-4xl mx-auto w-full">
                ...
                <p className="text-sm text-gray-500 mb-6">
                    Paso 2: define cómo se cuentan los votos y qué modelos de
                    candidatura son válidos.
                </p>
                ...
                <div className="bg-white border rounded-xl p-6 mb-4">
                    <div className="flex items-center gap-2 mb-5">
                        ...
                        <h2 className="font-semibold text-gray-900">
                            Seleccionar Método Electoral
                        </h2>
                    </div>

                    {presetTipoEleccion && (
                        <div className="mb-4 rounded-xl border border-red-100 bg-red-50 px-4 py-3 text-sm text-red-700">
                            Este tipo de elección fija automáticamente el método
                            electoral en {metodoSeleccionado}.
                        </div>
                    )}
                ...
                <div className="bg-white border rounded-xl p-6 mb-4">
                    <div className="flex items-center gap-2 mb-5">
                        ...
                        <h2 className="font-semibold text-gray-900">
                            Configuración de Reglas de Victoria
                        </h2>
                    </div>
                                ...
                                <div>
                                    <div className="rounded-xl border border-blue-100 bg-blue-50 px-4 py-3 mb-5">
                                        ...
                                        <p className="text-xs text-blue-700">
                                            El Senado se elige en
                                            circunscripción nacional. Todos los
                                            partidos compiten en el ámbito del
                                    ...
                                    <div className="grid grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-400 mt-1">
                                                Mínimo para asignar curules. Ej:
                                                3%.
                                            </p>
                                        </div>
                                ...
                                <div>
                                    <div className="rounded-xl border border-amber-100 bg-amber-50 px-4 py-3 mb-5">
                                        ...
                                        <p className="text-xs text-amber-700">
                                            Cada departamento tiene una
                                            circunscripción propia. Asigna el
                                            número de curules y el umbral para
                                            cada uno.
                                        </p>
                                    </div>
                                                ...
                                                (esp, idx) => (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            <p
                                                                className={`text-sm font-semibold ${esp.habilitada ? "text-gray-800" : "text-gray-400"}`}
                                                            >
                                                                {esp.nombre}
                                                            </p>
                        ...
                        <>
                            {metodoConfig.usaConteoDirecto && (
                                <div className="rounded-xl border border-green-200 bg-green-50 p-4 text-sm text-green-800 mb-4">
                                    Regla activa: conteo directo de votos. No
                                    aplica umbral electoral ni método de
                                    curules.
                                </div>
                            )}
                            ...
                            {metodoConfig.umbralFijo && (
                                <div className="grid grid-cols-2 gap-4 mb-4">
                                    ...
                                    <div className="rounded-xl border border-red-100 bg-red-50 p-4 text-sm text-red-700">
                                        Configuración clave: si nadie supera el
                                        50%, el sistema debe preparar una
                                        segunda vuelta.
                                    </div>
                                </div>
                            )}
                            ...
                            {metodoConfig.usaRedistribucion && (
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="rounded-xl border border-gray-200 p-4 bg-white">
                                        ...
                                        <p className="text-xs text-gray-500">
                                            El sistema elimina al candidato con
                                            menos votos en cada ronda.
                                        </p>
                                    </div>
                                    <div className="rounded-xl border border-gray-200 p-4 bg-white">
                                        <p className="text-sm font-semibold text-gray-900 mb-1">
                                            Redistribución de preferencias
                                        </p>
                                        <p className="text-xs text-gray-500">
                                            Los votos se reasignan según el
                                            siguiente orden marcado por el
                                            votante.
                                        </p>
                                    </div>
                                </div>
                ...
                <div className="bg-white border rounded-xl p-6 mb-4">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        {modelos.map((modelo) => {
                            ...
                            const selected = modelosCandidatura.includes(
                                modelo.id,
                            );
                            const disabled = !modelosCompatibles.includes(
                                modelo.id,
                            );
                            return (
                                <button
                    ...
                    {metodoSeleccionado === "ME-03" && (
                        <div className="mt-3 rounded-lg border border-blue-100 bg-blue-50 px-3 py-2 text-xs text-blue-700">
                            Puedes seleccionar <strong>Lista Abierta</strong>,{" "}
                            <strong>Lista Cerrada</strong> o{" "}
                            <strong>ambas</strong> simultáneamente. Al menos una
                            debe quedar seleccionada.
                        </div>
                    )}

                    <p className="text-xs text-gray-400 mt-2">
                        {getModeloHelperText(metodoSeleccionado)}
                    </p>
                </div>
                        ...
                        <div className="border border-gray-200 rounded-lg p-4">
                            <div className="flex items-start justify-between gap-3">
                                <div className="flex-1">
                                    ...
                                    <p className="text-xs text-gray-500">
                                        Mantiene la opción oficial de voto en
                                        blanco en el tarjetón.
                                    </p>
                                </div>
                                <button
                                    type="button"
                                    onClick={() =>
                                        setVotoBlancoHabilitado(
                                            !votoBlancoHabilitado,
                                        )
                                    }
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    onChange={(e) =>
                                        setIdiomaTargeton(e.target.value)
                                    }
                                    className="w-full appearance-none border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-red-300"
                                >
                                    <option value="es-CO">
                ...
                {(errorGuardado || guardadoExitoso) && (
                    ...
                    >
                        {errorGuardado ||
                            "Avance del paso 2 guardado localmente. Se enviará al final."}
                    </div>
                )}
            ...
            <footer className="border-t bg-white py-3 px-8 text-center text-xs text-gray-400">
                Certificado ISO 27001 &nbsp;|&nbsp; Regulado por el CNE
                (Colombia) &nbsp;|&nbsp; Estándar de Sistemas a Sistema
            </footer>
        </div>
    );
}
